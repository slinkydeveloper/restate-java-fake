 ...
 * <p>
 * This record defines the expected behavior and configuration for a fake context used in testing.
 * It controls various aspects including:
 * <ul>
 *   <li>Random seed used by {@link Context#random()}</li>
 *   <li>Expectations for {@link Context#run}</li>
 *   <li>Timers' completion conditions (for {@link Context#timer)}</li>
 * </ul>
 * <p>
...
public record ContextExpectations(
    ...
    public ContextExpectations() {
        this(1, "inv_1aiqX0vFEFNH1Umgre58JiCLgHfTtztYK5", Map.of(), Map.of(), (i1, i2) -> false, JacksonSerdeFactory.DEFAULT);
    }
    ...
    public ContextExpectations withRandomSeed(long randomSeed) {
        return new ContextExpectations(randomSeed, this.invocationId, this.requestHeaders, this.runExpectations, this.completeTimerIf, this.serdeFactory);
    }
    ...
    public ContextExpectations withInvocationId(String invocationId) {
        return new ContextExpectations(this.randomSeed, invocationId, this.requestHeaders, this.runExpectations, this.completeTimerIf, this.serdeFactory);
    }
    ...
    public ContextExpectations withRequestHeaders(Map<String, String> requestHeaders) {
        return new ContextExpectations(this.randomSeed, this.invocationId, requestHeaders, this.runExpectations, this.completeTimerIf, this.serdeFactory);
    }
     ...
     * <p>
     * The mocked context will try to execute the run, and in case of a failure,
     * the given exception will <b>be thrown as is</b>.
     *
     ...
     * <p>
     * The mocked context will try to execute the run, and in case of a failure,
     * the given exception will be converted to {@link dev.restate.sdk.common.TerminalException}.
     * <p>
     ...
     * <p>
     * This is useful when testing a flow where you either want to wait a {@code ctx.run} to complete, or another event (such as timers)
     *
    ...
    public ContextExpectations completeAllTimersImmediately() {
        return new ContextExpectations(this.randomSeed, this.invocationId, requestHeaders, this.runExpectations, (i1, i2) -> true, this.serdeFactory);
    }
    ...
    private ContextExpectations withRunExpectation(String runName, RunExpectation expectation) {
        return new ContextExpectations(this.randomSeed, this.invocationId, requestHeaders,
                Stream.concat(
                                this.runExpectations.entrySet().stream(),
                                Stream.of(Map.entry(runName, expectation)))
                        .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue)), this.completeTimerIf,this.serdeFactory
        );
    }

    private ContextExpectations completeTimerIf(BiPredicate<Duration, String> completeTimerIf) {
        return new ContextExpectations(this.randomSeed, this.invocationId, requestHeaders, this.runExpectations, (d, n) -> this.completeTimerIf.test(d, n) || completeTimerIf.test(d, n), this.serdeFactory);
    }
}
